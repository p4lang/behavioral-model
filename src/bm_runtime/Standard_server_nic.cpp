...
class StandardHandlerNic : virtual public StandardIf {
public:
  StandardHandlerNic(NicWContexts *sw)
    : nic_(sw) { }
  ...
  int64_t bm_mt_get_num_entries(const int32_t cxt_id, const std::string& table_name) {
    ...
    MatchErrorCode error_code = nic_->mt_get_num_entries(
  ...
  void bm_mt_clear_entries(const int32_t cxt_id, const std::string& table_name, const bool reset_default_entry) {
    ...
    auto error_code = nic_->mt_clear_entries(
  ...
  BmEntryHandle bm_mt_add_entry(const int32_t cxt_id, const std::string& table_name, const BmMatchParams& match_key, const std::string& action_name, const BmActionData& action_data, const BmAddEntryOptions& options) {
    ...
    MatchErrorCode error_code = nic_->mt_add_entry(
  ...
  void bm_mt_set_default_action(const int32_t cxt_id, const std::string& table_name, const std::string& action_name, const BmActionData& action_data) {
    ...
    MatchErrorCode error_code = nic_->mt_set_default_action(
  ...
  void bm_mt_reset_default_entry(const int32_t cxt_id, const std::string& table_name) {
    ...
    auto error_code = nic_->mt_reset_default_entry(cxt_id, table_name);
    if(error_code != MatchErrorCode::SUCCESS) {
      InvalidTableOperation ito;
      ito.code = get_exception_code(error_code);
      throw ito;
  ...
  void bm_mt_delete_entry(const int32_t cxt_id, const std::string& table_name, const BmEntryHandle entry_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_delete_entry(
  ...
  void bm_mt_modify_entry(const int32_t cxt_id, const std::string& table_name, const BmEntryHandle entry_handle, const std::string &action_name, const BmActionData& action_data) {
    ...
    MatchErrorCode error_code = nic_->mt_modify_entry(
  ...
  void bm_mt_set_entry_ttl(const int32_t cxt_id, const std::string& table_name, const BmEntryHandle entry_handle, const int32_t timeout_ms) {
    ...
    MatchErrorCode error_code = nic_->mt_set_entry_ttl(
        cxt_id, table_name, entry_handle,
  ...
  BmMemberHandle bm_mt_act_prof_add_member(const int32_t cxt_id, const std::string& act_prof_name, const std::string& action_name, const BmActionData& action_data) {
    ...
    MatchErrorCode error_code = nic_->mt_act_prof_add_member(
  ...
  void bm_mt_act_prof_delete_member(const int32_t cxt_id, const std::string& act_prof_name, const BmMemberHandle mbr_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_act_prof_delete_member(
  ...
  void bm_mt_act_prof_modify_member(const int32_t cxt_id, const std::string& act_prof_name, const BmMemberHandle mbr_handle, const std::string& action_name, const BmActionData& action_data) {
    ...
    MatchErrorCode error_code = nic_->mt_act_prof_modify_member(
  ...
  BmGroupHandle bm_mt_act_prof_create_group(const int32_t cxt_id, const std::string& act_prof_name) {
    ...
    MatchErrorCode error_code = nic_->mt_act_prof_create_group(
  ...
  void bm_mt_act_prof_delete_group(const int32_t cxt_id, const std::string& act_prof_name, const BmGroupHandle grp_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_act_prof_delete_group(
        cxt_id, act_prof_name, grp_handle);
    if(error_code != MatchErrorCode::SUCCESS) {
      InvalidTableOperation ito;
      ito.code = get_exception_code(error_code);
  ...
  void bm_mt_act_prof_add_member_to_group(const int32_t cxt_id, const std::string& act_prof_name, const BmMemberHandle mbr_handle, const BmGroupHandle grp_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_act_prof_add_member_to_group(
  ...
  void bm_mt_act_prof_remove_member_from_group(const int32_t cxt_id, const std::string& act_prof_name, const BmMemberHandle mbr_handle, const BmGroupHandle grp_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_act_prof_remove_member_from_group(
        cxt_id, act_prof_name, mbr_handle, grp_handle);
    if(error_code != MatchErrorCode::SUCCESS) {
      InvalidTableOperation ito;
      ito.code = get_exception_code(error_code);
  ...
  BmEntryHandle bm_mt_indirect_add_entry(const int32_t cxt_id, const std::string& table_name, const BmMatchParams& match_key, const BmMemberHandle mbr_handle, const BmAddEntryOptions& options) {
    ...
    std::vector<MatchKeyParam> params;
    build_match_key(params, match_key);
    MatchErrorCode error_code = nic_->mt_indirect_add_entry(
  ...
  void bm_mt_indirect_modify_entry(const int32_t cxt_id, const std::string& table_name, const BmEntryHandle entry_handle, const BmMemberHandle mbr_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_indirect_modify_entry(
  ...
  void bm_mt_indirect_delete_entry(const int32_t cxt_id, const std::string& table_name, const BmEntryHandle entry_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_indirect_delete_entry(
        cxt_id, table_name, entry_handle);
    if(error_code != MatchErrorCode::SUCCESS) {
      InvalidTableOperation ito;
      ito.code = get_exception_code(error_code);
  ...
  void bm_mt_indirect_set_entry_ttl(const int32_t cxt_id, const std::string& table_name, const BmEntryHandle entry_handle, const int32_t timeout_ms) {
    ...
    MatchErrorCode error_code = nic_->mt_indirect_set_entry_ttl(
        cxt_id, table_name, entry_handle,
        static_cast<unsigned int>(timeout_ms));
    if(error_code != MatchErrorCode::SUCCESS) {
      InvalidTableOperation ito;
  ...
  void bm_mt_indirect_set_default_member(const int32_t cxt_id, const std::string& table_name, const BmMemberHandle mbr_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_indirect_set_default_member(
  ...
  void bm_mt_indirect_reset_default_entry(const int32_t cxt_id, const std::string& table_name) {
    ...
    auto error_code = nic_->mt_indirect_reset_default_entry(
        cxt_id, table_name);
    if(error_code != MatchErrorCode::SUCCESS) {
      InvalidTableOperation ito;
      ito.code = get_exception_code(error_code);
  ...
  BmEntryHandle bm_mt_indirect_ws_add_entry(const int32_t cxt_id, const std::string& table_name, const BmMatchParams& match_key, const BmGroupHandle grp_handle, const BmAddEntryOptions& options) {
    ...
    std::vector<MatchKeyParam> params;
    build_match_key(params, match_key);
    MatchErrorCode error_code = nic_->mt_indirect_ws_add_entry(
  ...
  void bm_mt_indirect_ws_modify_entry(const int32_t cxt_id, const std::string& table_name, const BmEntryHandle entry_handle, const BmGroupHandle grp_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_indirect_ws_modify_entry(
  ...
  void bm_mt_indirect_ws_set_default_group(const int32_t cxt_id, const std::string& table_name, const BmGroupHandle grp_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_indirect_ws_set_default_group(
  ...
  void bm_mt_read_counter(BmCounterValue& _return, const int32_t cxt_id, const std::string& table_name, const BmEntryHandle entry_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_read_counters(
  ...
  void bm_mt_reset_counters(const int32_t cxt_id, const std::string& table_name) {
    ...
    MatchErrorCode error_code = nic_->mt_reset_counters(
        cxt_id, table_name);
    if(error_code != MatchErrorCode::SUCCESS) {
      InvalidTableOperation ito;
      ito.code = get_exception_code(error_code);
  ...
  void bm_mt_write_counter(const int32_t cxt_id, const std::string& table_name, const BmEntryHandle entry_handle, const BmCounterValue& value) {
    ...
    MatchErrorCode error_code = nic_->mt_write_counters(
        cxt_id, table_name, entry_handle, bytes, packets);
    if(error_code != MatchErrorCode::SUCCESS) {
      InvalidTableOperation ito;
      ito.code = get_exception_code(error_code);
  ...
  void bm_mt_set_meter_rates(const int32_t cxt_id, const std::string& table_name, const BmEntryHandle entry_handle, const std::vector<BmMeterRateConfig> & rates) {
    ...
    MatchErrorCode error_code = nic_->mt_set_meter_rates(
  ...
  void bm_mt_get_meter_rates(std::vector<BmMeterRateConfig> & _return, const int32_t cxt_id, const std::string& table_name, const BmEntryHandle entry_handle) {
    ...
    MatchErrorCode error_code = nic_->mt_get_meter_rates(
  ...
  void get_entries_common(cxt_id_t cxt_id, const std::string &table_name,
    ...
    const auto entries = std::bind(GetFn, nic_, cxt_id, table_name)();
  ...
  void get_entry_common(cxt_id_t cxt_id, const std::string &table_name,
    ...
    auto rc = std::bind(GetFn, nic_, cxt_id, table_name, handle, &entry)();
  ...
  void bm_mt_get_entries(std::vector<BmMtEntry> & _return, const int32_t cxt_id, const std::string& table_name) {
    ...
    switch (nic_->mt_get_type(cxt_id, table_name)) {
  ...
  typename M::Entry get_default_entry_common(
    ...
    typename M::Entry entry;
    auto error_code = std::bind(GetFn, nic_, cxt_id, table_name, &entry)();
  ...
  void get_entry_from_key_common(cxt_id_t cxt_id, const std::string &table_name,
    ...
    typename M::Entry entry;
    auto rc = std::bind(
        GetFn, nic_, cxt_id, table_name, params, &entry, options.priority)();
    if(rc != MatchErrorCode::SUCCESS) {
      InvalidTableOperation ito;
      ito.code = get_exception_code(rc);
      throw ito;
  ...
  void bm_mt_act_prof_get_members(std::vector<BmMtActProfMember> & _return, const int32_t cxt_id, const std::string& act_prof_name) {
    ...
    const auto members = nic_->mt_act_prof_get_members(
  ...
  void bm_mt_act_prof_get_member(BmMtActProfMember& _return, const int32_t cxt_id, const std::string& act_prof_name, const BmMemberHandle mbr_handle) {
    ...
    auto rc = nic_->mt_act_prof_get_member(
  ...
  void bm_mt_act_prof_get_groups(std::vector<BmMtActProfGroup> & _return, const int32_t cxt_id, const std::string& act_prof_name) {
    ...
    const auto groups = nic_->mt_act_prof_get_groups(cxt_id, act_prof_name);
  ...
  void bm_mt_act_prof_get_group(BmMtActProfGroup& _return, const int32_t cxt_id, const std::string& act_prof_name, const BmGroupHandle grp_handle) {
    ...
    auto rc = nic_->mt_act_prof_get_group(
  ...
  void bm_counter_read(BmCounterValue& _return, const int32_t cxt_id, const std::string& counter_name, const int32_t index) {
    ...
    MatchTable::counter_value_t bytes;  // unsigned
    MatchTable::counter_value_t packets;
    Counter::CounterErrorCode error_code = nic_->read_counters(
  ...
  void bm_counter_reset_all(const int32_t cxt_id, const std::string& counter_name) {
    ...
    Counter::CounterErrorCode error_code = nic_->reset_counters(
        cxt_id, counter_name);
    if(error_code != Counter::CounterErrorCode::SUCCESS) {
      InvalidCounterOperation ico;
      ico.code = (CounterOperationErrorCode::type) error_code;
  ...
  void bm_counter_write(const int32_t cxt_id, const std::string& counter_name, const int32_t index, const BmCounterValue& value) {
    ...
    MatchTable::counter_value_t bytes = (uint64_t) value.bytes;
    MatchTable::counter_value_t packets = (uint64_t) value.packets;
    Counter::CounterErrorCode error_code = nic_->write_counters(
  ...
  void bm_learning_ack(const int32_t cxt_id, const BmLearningListId list_id, const BmLearningBufferId buffer_id, const std::vector<BmLearningSampleId> & sample_ids) {
    ...
    auto error_code =
        nic_->get_learn_engine(cxt_id)->ack(list_id, buffer_id, sample_ids);
  ...
  void bm_learning_ack_buffer(const int32_t cxt_id, const BmLearningListId list_id, const BmLearningBufferId buffer_id) {
    ...
    auto error_code =
        nic_->get_learn_engine(cxt_id)->ack_buffer(list_id, buffer_id);
    if (error_code != LearnEngineIface::LearnErrorCode::SUCCESS) {
      InvalidLearnOperation ilo;
      ilo.code = (LearnOperationErrorCode::type) error_code;
      throw ilo;
  ...
  void bm_learning_set_timeout(const int32_t cxt_id, const BmLearningListId list_id, const int32_t timeout_ms) {
    ...
    auto error_code = nic_->get_learn_engine(cxt_id)->list_set_timeout(
        list_id, timeout_ms);
    if (error_code != LearnEngineIface::LearnErrorCode::SUCCESS) {
      InvalidLearnOperation ilo;
      ilo.code = (LearnOperationErrorCode::type) error_code;
  ...
  void bm_learning_set_buffer_size(const int32_t cxt_id, const BmLearningListId list_id, const int32_t nb_samples) {
    ...
    auto error_code = nic_->get_learn_engine(cxt_id)->list_set_max_samples(
        list_id, nb_samples);
    if (error_code != LearnEngineIface::LearnErrorCode::SUCCESS) {
      InvalidLearnOperation ilo;
      ilo.code = (LearnOperationErrorCode::type) error_code;
  ...
  void bm_load_new_config(const std::string& config_str) {
    ...
    RuntimeInterface::ErrorCode error_code =
      nic_->load_new_config(config_str);
  ...
  void bm_swap_configs() {
    ...
    RuntimeInterface::ErrorCode error_code = nic_->swap_configs();
    if(error_code != RuntimeInterface::ErrorCode::SUCCESS) {
      InvalidSwapOperation iso;
      iso.code = (SwapOperationErrorCode::type) error_code;
      throw iso;
  ...
  void bm_meter_array_set_rates(const int32_t cxt_id, const std::string& meter_array_name, const std::vector<BmMeterRateConfig> & rates) {
    ...
    Meter::MeterErrorCode error_code = nic_->meter_array_set_rates(
  ...
  void bm_meter_set_rates(const int32_t cxt_id, const std::string& meter_array_name, const int32_t index, const std::vector<BmMeterRateConfig> & rates) {
    ...
    Meter::MeterErrorCode error_code = nic_->meter_set_rates(
  ...
  void bm_meter_get_rates(std::vector<BmMeterRateConfig> & _return, const int32_t cxt_id, const std::string& meter_array_name, const int32_t index) {
    ...
    std::vector<Meter::rate_config_t> rates;
    Meter::MeterErrorCode error_code = nic_->meter_get_rates(
  ...
  BmRegisterValue bm_register_read(const int32_t cxt_id, const std::string& register_array_name, const int32_t index) {
    ...
    Register::RegisterErrorCode error_code = nic_->register_read(
  ...
  void bm_register_read_all(std::vector<BmRegisterValue> & _return, const int32_t cxt_id, const std::string& register_array_name) {
    ...
    auto entries = nic_->register_read_all(cxt_id, register_array_name);
    if (entries.empty()) {
      InvalidRegisterOperation iro;
  ...
  void bm_register_write(const int32_t cxt_id, const std::string& register_array_name, const int32_t index, const BmRegisterValue value) {
    ...
    Register::RegisterErrorCode error_code = nic_->register_write(
  ...
  void bm_register_write_range(const int32_t cxt_id, const std::string& register_array_name, const int32_t start_index, const int32_t end_index, const BmRegisterValue value) {
    ...
    Register::RegisterErrorCode error_code = nic_->register_write_range(
  ...
  void bm_register_reset(const int32_t cxt_id, const std::string& register_array_name) {
    ...
    Register::RegisterErrorCode error_code = nic_->register_reset(
  ...
  void bm_parse_vset_add(const int32_t cxt_id, const std::string& parse_vset_name, const BmParseVSetValue& value) {
    ...
    ParseVSet::ErrorCode error_code = nic_->parse_vset_add(
  ...
  void bm_parse_vset_remove(const int32_t cxt_id, const std::string& parse_vset_name, const BmParseVSetValue& value) {
    ...
    ParseVSet::ErrorCode error_code = nic_->parse_vset_remove(
        cxt_id, parse_vset_name, ByteContainer(value.data(), value.size()));
    if(error_code != ParseVSet::ErrorCode::SUCCESS) {
      InvalidParseVSetOperation ipo;
      ipo.code = (ParseVSetOperationErrorCode::type) error_code;
  ...
  void bm_parse_vset_get(std::vector<BmParseVSetValue> & _return, const int32_t cxt_id, const std::string& parse_vset_name) {
    ...
    ParseVSet::ErrorCode error_code = nic_->parse_vset_get(
  ...
  void bm_parse_vset_clear(const int32_t cxt_id, const std::string& parse_vset_name) {
    ...
    ParseVSet::ErrorCode error_code = nic_->parse_vset_clear(
  ...
  void bm_dev_mgr_add_port(const std::string& iface_name, const int32_t port_num, const std::string& pcap_path) {
    ...
    error_code = nic_->port_add(iface_name, port_num, port_extras);
  ...
  void bm_dev_mgr_remove_port(const int32_t port_num) {
    ...
    DevMgr::ReturnCode error_code;
    error_code = nic_->port_remove(port_num);
    if(error_code != DevMgr::ReturnCode::SUCCESS) {
      InvalidDevMgrOperation idmo;
      idmo.code = (DevMgrErrorCode::type) 1; // TODO
      throw idmo;
  ...
  void bm_mgmt_get_info(BmConfig& _return) {
    ...
    _return.device_id = nic_->get_device_id();
    _return.thrift_port = nic_->get_runtime_port();
    _return.__set_notifications_socket(nic_->get_notifications_addr());
    {
      std::string s = nic_->get_event_logger_addr();
      if (s != "") _return.__set_elogger_socket(s);
    }
    {
      std::string s = nic_->get_debugger_addr();
  ...
  void bm_set_crc16_custom_parameters(const int32_t cxt_id, const std::string& calc_name, const BmCrc16Config& crc16_config) {
    ...
    auto rc = nic_->set_crc16_custom_parameters(cxt_id, calc_name, c);
  ...
  void bm_set_crc32_custom_parameters(const int32_t cxt_id, const std::string& calc_name, const BmCrc32Config& crc32_config) {
    ...
    auto rc = nic_->set_crc32_custom_parameters(cxt_id, calc_name, c);
    if(rc != CustomCrcErrorCode::SUCCESS) {
      InvalidCrcOperation ico;
      ico.code = static_cast<CrcErrorCode::type>(rc); // TODO
      throw ico;
  ...
  void bm_set_toeplitz_hash_key(const int32_t cxt_id, const std::string& calc_name, const BmToeplitzHashKey& raw_key) {
    ...
    auto rc = nic_->set_toeplitz_key(cxt_id, calc_name, key);
  ...
  int32_t bm_get_id_from_name(const int32_t cxt_id, const BmResourceType::type resource_type, const std::string& resource_name) {
    ...
    auto rc = nic_->p4objects_id_from_name(
...
template <>
void
StandardHandlerNic::build_action_entry<MatchTable::Entry>(
...
template <>
void
StandardHandlerNic::build_action_entry<MatchTableIndirect::Entry>(
...
template <>
void
StandardHandlerNic::build_action_entry<MatchTableIndirectWS::Entry>(
...
void StandardHandlerNic::copy_one_member(
...
void StandardHandlerNic::copy_one_group(
...
::stdcxx::shared_ptr<StandardIf> get_handler(NicWContexts *nic_) {
  return ::stdcxx::shared_ptr<StandardHandlerNic>(new StandardHandlerNic(nic_));
}
