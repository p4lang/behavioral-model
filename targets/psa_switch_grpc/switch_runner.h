...
#ifndef PSA_SWITCH_GRPC_SWITCH_RUNNER_H_
#define PSA_SWITCH_GRPC_SWITCH_RUNNER_H_
...
class PsaSwitchGrpcRunner {
 public:
  ...
  static PsaSwitchGrpcRunner &get_instance(
    ...
    static PsaSwitchGrpcRunner instance(
 ...
 private:
  PsaSwitchGrpcRunner(bool enable_swap = false,
                         std::string grpc_server_addr = "0.0.0.0:9559",
                         bm::DevMgrIface::port_t cpu_port = 0,
                         std::string dp_grpc_server_addr = "",
                         bm::DevMgrIface::port_t drop_port = default_drop_port,
  ...
  std::unique_ptr<bm::psa::PsaSwitch> psa_switch;
...
#endif  // PSA_SWITCH_GRPC_SWITCH_RUNNER_H_
