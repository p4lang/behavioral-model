...
class PsaSwitchGrpcTest_PreBase : public PsaSwitchGrpcBaseTest {
 protected:
  using StreamType = grpc::ClientReaderWriter<p4::bm::PacketStreamRequest,
                                              p4::bm::PacketStreamResponse>;

  PsaSwitchGrpcTest_PreBase(const char *json_path, const char *proto_path)
      : PsaSwitchGrpcBaseTest(proto_path),
...
class PsaSwitchGrpcTest_Multicast : public PsaSwitchGrpcTest_PreBase<
  ::p4v1::MulticastGroupEntry,
  &::p4v1::PacketReplicationEngineEntry::mutable_multicast_group_entry> {
 protected:
  PsaSwitchGrpcTest_Multicast()
      : PsaSwitchGrpcTest_PreBase(multicast_json, multicast_proto) { }
...
TEST_F(PsaSwitchGrpcTest_Multicast, 2Rids3Ports) {
  int16_t group_id = 10;
  GroupEntry group;
...
class PsaSwitchGrpcTest_Clone : public PsaSwitchGrpcTest_PreBase<
  ::p4v1::CloneSessionEntry,
  &::p4v1::PacketReplicationEngineEntry::mutable_clone_session_entry> {
 protected:
  PsaSwitchGrpcTest_Clone()
      : PsaSwitchGrpcTest_PreBase(clone_json, clone_proto) { }
...
TEST_F(PsaSwitchGrpcTest_Clone, SingletonAndMulticast) {
