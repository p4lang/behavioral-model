...
class PsaSwitchGrpcTest_Basic : public PsaSwitchGrpcBaseTest {
 protected:
  PsaSwitchGrpcTest_Basic()
      : PsaSwitchGrpcBaseTest(simple_router_proto) {
...
TEST_F(PsaSwitchGrpcTest_Basic, Entries) {
...
TEST_F(PsaSwitchGrpcTest_Basic, DefaultEntry) {
