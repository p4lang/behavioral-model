...
class PsaSwitchGrpcTest_Digest : public PsaSwitchGrpcBaseTest {
 protected:
  PsaSwitchGrpcTest_Digest()
...
PsaSwitchGrpcTest_Digest::timeout0ms;
/* static */ constexpr std::chrono::milliseconds
PsaSwitchGrpcTest_Digest::timeout1000ms;
/* static */ constexpr std::chrono::milliseconds
PsaSwitchGrpcTest_Digest::defaultTimeout;

TEST_F(PsaSwitchGrpcTest_Digest, OneSample) {
...
TEST_F(PsaSwitchGrpcTest_Digest, Ack) {
...
TEST_F(PsaSwitchGrpcTest_Digest, DeleteDigest) {
  const std::string smac("\x11\x22\x33\x44\x55\x66");
