...
class PsaSwitchGrpcTest_Optional : public PsaSwitchGrpcBaseTest {
 protected:
  PsaSwitchGrpcTest_Optional()
      : PsaSwitchGrpcBaseTest(optional_proto),
...
TEST_F(PsaSwitchGrpcTest_Optional, ReadEntry) {
  int priority = 128;
...
TEST_F(PsaSwitchGrpcTest_Optional, BothEntries) {
...
TEST_F(PsaSwitchGrpcTest_Optional, PriorityZero) {
  int priority = 0;
