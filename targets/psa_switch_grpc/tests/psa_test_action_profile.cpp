...
class PsaSwitchGrpcTest_ActionProfile : public PsaSwitchGrpcBaseTest {
 protected:
  PsaSwitchGrpcTest_ActionProfile()
      : PsaSwitchGrpcBaseTest(act_prof_proto),
...
TEST_F(PsaSwitchGrpcTest_ActionProfile, WatchPort) {
  {  // oneshot programming
    p4v1::Entity entity;
...
// members.
TEST_F(PsaSwitchGrpcTest_ActionProfile, DeleteGroupWithMembers) {
  int group_id(1);
