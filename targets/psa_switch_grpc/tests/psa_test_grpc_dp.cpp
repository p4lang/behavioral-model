...
class PsaSwitchGrpcTest_GrpcDataplane : public PsaSwitchGrpcBaseTest {
 protected:
  PsaSwitchGrpcTest_GrpcDataplane()
      : PsaSwitchGrpcBaseTest(loopback_proto),
...
TEST_F(PsaSwitchGrpcTest_GrpcDataplane, SendAndReceive) {
...
TEST_F(PsaSwitchGrpcTest_GrpcDataplane, MultipleClients) {
  ClientContext context1;
