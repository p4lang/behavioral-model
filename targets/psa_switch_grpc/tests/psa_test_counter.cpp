...
class PsaSwitchGrpcTest_Counter : public PsaSwitchGrpcBaseTest {
 protected:
  PsaSwitchGrpcTest_Counter()
      : PsaSwitchGrpcBaseTest(counter_proto),
...
TEST_F(PsaSwitchGrpcTest_Counter, CounterHit) {
