...
class PsaSwitchGrpcTest_Meter : public PsaSwitchGrpcBaseTest {
 protected:
  PsaSwitchGrpcTest_Meter()
      : PsaSwitchGrpcBaseTest(meter_proto),
...
TEST_F(PsaSwitchGrpcTest_Meter, ReadDefault) {
