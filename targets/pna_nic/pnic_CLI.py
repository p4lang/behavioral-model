...
class PnaNicAPI(runtime_CLI.RuntimeAPI):
    ...
    #         self.pnic_client.set_egress_queue_depth(port, depth)
    #     else:
    #         self.pnic_client.set_all_egress_queue_depths(depth)
    ...
    #     if len(args) > 1:
    #         port = self.parse_int(args[1], "egress_port")
    #         self.pnic_client.set_egress_queue_rate(port, rate)
    #     else:
    #         self.pnic_client.set_all_egress_queue_rates(rate)
